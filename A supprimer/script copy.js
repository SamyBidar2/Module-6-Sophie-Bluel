...
function OuvrirModale(){
  ...
  // Ajouter un écouteur d'événements pour arrêter la propagation
  AfficherModale.addEventListener('click', stopPropagation);
}
...
function FermerModale() {
  ...
  // Retirer l'écouteur d'événements après la fermeture de la fenêtre modale
  FermerModale.removeEventListener('click', stopPropagation);
